...
int main() {
  CDT cdt;
  cdt.insert(CDT::Point(100, 100));
  cdt.insert(CDT::Point(200, 300));
  cdt.insert(CDT::Point(400, 500));
  cdt.insert(CDT::Point(100, 800));
  cdt.insert(CDT::Point(200, 600));
  cdt.insert(CDT::Point(400, 200));
